        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    if(data[10]) {
                        cols += '<td><input type="text" class="form-control batch-no d-none" name="batch_no[]" required/></td>';
                        cols += '<td><input type="text" class="form-control expired-date d-none" name="expired_date[]" required/></td>';
                    }
                    else {
                        cols += '<td><input type="text" class="form-control batch-no d-none" name="batch_no[]" disabled/></td>';
                        cols += '<td><input type="text" class="form-control expired-date d-none" name="expired_date[]" disabled/></td>';
                    }
