...
// dd('ada', $lims_warehouse_list);
            return view('backend.warrenty.index',compact('starting_date', 'ending_date', 'warehouse_id', 'all_permission', 'lims_warehouse_list'));
        }
        else
    ...
    public function returnData(Request $request)
    {
        ...
        if(!empty($returnss))
        {
            ...
            {
                // dd('$returns->grand_total',$returns->grand_total);
    ...
    public function create(Request $request)
    {
        ...
        if($role->hasPermissionTo('returns-add')) {
            ...
            $lims_warehouse_list = Warehouse::where('is_active',true)->get();
            return view('backend.warrenty.create', compact('lims_tax_list', 'lims_sale_data', 'lims_product_sale_data', 'lims_warehouse_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('warrenty')->with('message', $message);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('warrenty')->with('not_permitted', 'Data deleted successfully');;
    }
}
