    ...
    public function update(Request $request)
    {
        ...
        if(isset($request->feature_icon))
        {
            ...
            if(!config('database.connections.saleprosaas_landlord')) {
                ...
                $image->move('frontend/images/features', $imageName);
                $img = Image::make('frontend/images/features/'. $imageName)->fit(100, 100)->save('frontend/images/features/'. $imageName, 100);
