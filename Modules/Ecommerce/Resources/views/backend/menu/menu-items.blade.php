...
<section>
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-0">
            <div class="card-body">
                <h4><span>{{trans('file.Add Menu Items')}}</span>- <strong>{{$desiredMenu->title}}</strong></h4>
            </div>
        </div>
        ...
        <div class="row" id="main-row">
                ...
                <div class="accordion" id="menu-items">
                    <div class="card">
                        <div class="card-header">
                            <h4 data-toggle="collapse" data-target="#categories-list" aria-expanded="true" aria-controls="categories-list">{{trans('file.Categories')}} <span class="pull-right"><i class="dripicons-chevron-down"></i></span></h4>
                        </div>
                        <div class="collapse show" id="categories-list" data-parent="#accordionExample" data-parent="#menu-items">
                            <div class="card-body">
                                ...
                                <div class="item-list-footer">
                                    <label class="btn btn-sm btn-default"><input type="checkbox" id="select-all-categories"> {{trans('file.Select All')}}</label>
                                    <button type="button" class="pull-right btn btn-default btn-sm" id="add-categories">{{trans('file.Add to Menu')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h4 data-toggle="collapse" data-target="#collections-list" aria-expanded="flase" aria-controls="collections-list">{{trans('file.Collections')}} <span class="pull-right"><i class="dripicons-chevron-down"></i></span></h4>
                        </div>
                        <div class="collapse" id="collections-list" data-parent="#accordionExample" data-parent="#menu-items">
                            <div class="card-body">
                                ...
                                <div class="item-list-footer">
                                    <label class="btn btn-sm btn-default"><input type="checkbox" id="select-all-collections"> {{trans('file.Select All')}}</label>
                                    <button type="button" class="pull-right btn btn-default btn-sm" id="add-collections">{{trans('file.Add to Menu')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h4 data-toggle="collapse" data-target="#brands-list" aria-expanded="flase" aria-controls="brands-list">{{trans('file.Brands')}} <span class="pull-right"><i class="dripicons-chevron-down"></i></span></h4>
                        </div>
                        <div class="collapse" id="brands-list" data-parent="#accordionExample" data-parent="#menu-items">
                            <div class="card-body">
                                ...
                                <div class="item-list-footer">
                                    <label class="btn btn-sm btn-default"><input type="checkbox" id="select-all-brands"> {{trans('file.Select All')}}</label>
                                    <button type="button" class="pull-right btn btn-default btn-sm" id="add-brands">{{trans('file.Add to Menu')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h4 href="#pages-list" data-toggle="collapse" data-target="#pages-list" aria-expanded="false" aria-controls="pages-list">{{trans('file.Pages')}} <span class="pull-right"><i class="dripicons-chevron-down"></i></span></h4>
                        </div>
                        <div class="collapse" id="pages-list" data-parent="#menu-items">
                            <div class="card-body">
                                ...
                                <div class="item-list-footer">
                                    <label class="btn btn-sm btn-default"><input type="checkbox" id="select-all-pages"> {{trans('file.Select All')}}</label>
                                    <button type="button" id="add-pages" class="pull-right btn btn-default btn-sm">{{trans('file.Add to Menu')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h4 href="#blog-list" data-toggle="collapse" data-target="#blog-list" aria-expanded="false" aria-controls="blog-list">{{trans('file.Blog')}} <span class="pull-right"><i class="dripicons-chevron-down"></i></span></h4>
                        </div>
                        <div class="collapse" id="blog-list" data-parent="#menu-items">
                            <div class="card-body">
                                ...
                                <div class="item-list-footer">
                                    <button type="button" id="add-blog" class="pull-right btn btn-default btn-sm">{{trans('file.Add to Menu')}}</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 href="#custom-links" data-toggle="collapse" data-target="#custom-links" aria-expanded="false" aria-controls="custom-links">{{trans('file.Custom Links')}} <span class="pull-right"><i class="dripicons-chevron-down"></i></span></h4>
                        </div>
                        <div class="collapse" id="custom-links" data-parent="#menu-items">
                            <div class="card-body">
                                <div class="item-list-body">
                                    ...
                                    <div class="form-group">
                                        <label>{{trans('file.Link Text')}}</label>
                                        <input type="text" id="linktext" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="item-list-footer">
                                    <button type="button" class="pull-right btn btn-default btn-sm" id="add-custom-link">{{trans('file.Add to Menu')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-8 cat-view mt-3">
                <div class="card">
                    <div class="card-header">
                        <h3><span>{{trans('file.Menu Structure')}}</span></h3>
                    </div>
                    <div class="card-body">
                        <div id="menu-content">
                            <div id="result"></div>
                            <div style="min-height: 250px;">
                                <p>{{trans('file.Select categories, pages or add custom links to menus')}}.</p>
                                @if($desiredMenu != '')
                                        ...
                                        <div class="collapse" id="collapse{{$item->id}}">
                                            <div class="input-box">
                                                <form method="post" action="{{url('menu/menuitem/update')}}/{{$item->id}}">
                                                    {{csrf_field()}}
                                                    <div class="form-group">
                                                        <label>{{trans('file.Link Name')}}</label>
                                                    ...
                                                    <div class="form-group">
                                                        <input type="checkbox" name="target" value="_blank" @if($item->target == '_blank') checked @endif> {{trans('file.Open in a new tab')}}
                                                    </div>
                                                    @endif
                                                    <div class="form-group">
                                                ...
                                                <div class="collapse" id="collapse{{$data->id}}">
                                                    <div class="input-box">
                                                        <form method="post" action="{{url('update-menuitem')}}/{{$data->id}}">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="checkbox" name="target" value="_blank" @if($data->target == '_blank') checked @endif> {{trans('file.Open in a new tab')}}
                                                            </div>
                                                            @endif
                                                            <div class="form-group">
                                                                <button class="btn btn-sm btn-primary"><i class="dripicons-checkmark"></i></button>
                            ...
                            <div class="text-right">
                                <button class="btn btn-sm btn-primary" id="saveMenu">{{trans('file.Save Menu')}}</button>
                            </div>
                            @endif
                        </div>
                    </div>
