        ...
        <div class="table-responsive">
            <table id="department-table" class="table">
                ...
                <tr>
                    ...
                    <th>{{trans('Head Office Address')}}</th>
                    <th>{{trans('Factory Office Address')}}</th>
                    <th>{{trans('Status')}}</th>
                ...
                @foreach($companies as $key=>$company)
                    <tr data-id="{{$company->id}}">
                        <td>{{ $key }}</td>
                        <td>{{ $company->name }}</td>
                        <td>{{ $company->group->name??'Null' }}</td>
                        <td>{{ $company->area->name }}</td>
                        <td>{{ $company->head_office_address??'Null' }}</td>
                        <td>{{ $company->factory_office_address??'Null' }}</td>
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" id="head_office_address" name="head_office_address" class="form-control"></textarea>
                        </div>

                        <div class="form-group">
                            <label>{{trans('Factory Office Address')}}</label>
                            <textarea type="text" id="factory_office_address" name="factory_office_address" class="form-control"></textarea>
                        </div>
