    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <div class="input-group-prepend">
                <span class="input-group-text">ZML-</span>
            </div>
            ...
            <div class="input-group-append">
                <button id="genbutton" type="button" class="btn btn-sm btn-default" title="{{ trans('file.Generate') }}">
        ...
        <span class="validation-msg" id="code-error"></span>
                            ...
                            @endforeach
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('Attachment File')}}</strong> </label> 
                                        <input type="file" name="attachment" id="attachment" class="form-control" accept=".pdf,.jpg,.jpeg,.png,.gif">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 d-none" id="diffPrice-section">
                                    <div class="table-responsive ml-2">
