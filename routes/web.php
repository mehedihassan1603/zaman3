...
Route::group(['middleware' => ['common', 'auth', 'active']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('check-batch-availability/{product_id}/{batch_no}/{warehouse_id}', 'checkBatchAvailability')->name('check-batch-availability');
        // mehedi
        Route::get('get-batches/{product_id}/{variant_id}', 'getBatches')->name('get-batches');
    ...
    Route::controller(SaleController::class)->group(function () {
        ...
        Route::post('sales/whatsapp', 'sendWhatsApp')->name('sale.sendwhatsapp');
        ...
        Route::get('sales/gen_challan/{id}', 'genChallan')->name('sale.challan');
    ...
    Route::controller(QuotationController::class)->group(function () {
        Route::prefix('quotations')->group(function () {
            ...
            Route::post('whatsapp', 'sendWhatsApp')->name('quotation.sendwhatsapp');
            Route::post('deletebyselection', 'deleteBySelection');
        });
     });
    ...
    Route::controller(InquiryController::class)->group(function () {
        Route::prefix('inquiries')->group(function () {
            Route::post('inquiry-data', 'inquiryData')->name('inquiry.data');
            Route::get('product_inquiry/{id}','productInquiryData');
            Route::get('lims_product_search', 'limsProductSearch')->name('product_inquiry.search');
            Route::get('getcustomergroup/{id}', 'getCustomerGroup')->name('inquiry.getcustomergroup');
            Route::get('getproduct/{id}', 'getProduct')->name('inquiry.getproduct');
            Route::get('{id}/create_quotation', 'createQuotation')->name('inquiry.create_quotation');
            Route::get('{id}/create_purchase', 'createPurchase')->name('inquiry.create_purchase');
            Route::post('sendmail', 'sendMail')->name('inquiry.sendmail');
            Route::post('whatsapp', 'sendWhatsApp')->name('inquiry.sendwhatsapp');
            Route::post('deletebyselection', 'deleteBySelection');
        });
     });
    Route::resource('inquiries', InquiryController::class);
    Route::post('inquiries/data', [InquiryController::class, 'getData'])->name('inquiries.data');

    Route::get('/get-group-names', [InquiryController::class, 'getGroupNames'])->name('getGroupNames');
    Route::get('/get-company-names', [InquiryController::class, 'getCompanyNames'])->name('getCompanyNames');
    Route::get('/get-contact-person', [InquiryController::class, 'getContactPerson'])->name('getContactPerson');



    Route::delete('/inquiries/{id}', [InquiryController::class, 'deleteInquiry'])->name('inquiry.delete');
    Route::get('/inquiries/{id}/print', [InquiryController::class, 'print'])->name('inquiry.print');
    ...
    Route::controller(AdjustmentController::class)->group(function () {
        ...
        // Route::get('qty_adjustment/addsaleprice', 'addSalePrice')->name('qty_adjustment.addSalePrice');
        // Route::post('qty_adjustment/addsaleprice', 'addSaleStore')->name('qty_adjustment.addSaleStore');
        // Route::get('qty_adjustment/getproduct/{id}', 'getProduct')->name('adjustment.getproduct');
    });
    ...
    Route::controller(WarrentyController::class)->group(function () {
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::prefix('report')->group(function () {
            ...
            Route::get('agent_commission_report', 'agentCommissionReport')->name('report.agentCommissionReport');
            Route::post('agent_commission_report_data', 'agentCommissionReportData')->name('report.agentCommissionReportData');
            Route::get('single_product_report', 'singleProductReport')->name('report.singleProductReport');
            Route::post('single_product_report_data', 'singleProductReportData')->name('report.singleProductReportData');
            Route::get('product_report', 'productReport')->name('report.product');
            Route::get('product_report1', 'productReport1')->name('report.product1');
            Route::post('product_report_data', 'productReportData');
            Route::post('product_report_data1', 'productReportData1')->name('ReportData');
    ...
    Route::controller(StockCountController::class)->group(function () {
        ...
        Route::post('stock-count/sale_finalize', 'sale_finalize')->name('stock-count.sale_finalize');
        ...
        Route::get('stock-count/sale_index', 'sale_index')->name('stock-count.sale_index');
        Route::post('stock-count/sale_store', 'sale_store')->name('stock-count.sale_store');
        Route::post('stock-count/update-product-warehouse', 'updateProductWarehouse')->name('stock-count.updateProductWarehouse');
    ...
    Route::get('/get-company-address/{id}', [CompanyController::class, 'getAddress'])->name('get-company-address');
