    ...
    <div class="container-fluid"> 
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <button class="btn btn-primary" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">{{ trans('file.Add FAQ') }}</button>
                        <div class="collapse" id="collapseExample">
                            ...
                            @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>{{ trans('file.Question') }} *</label><br>
                                        <input class="form-control" type="text" name="question">
                                    </div>
                                    <div class="col-sm-12">
                                        <label>{{ trans('file.Answer') }} *</label><br>
                                        <input class="form-control" type="text" name="answer">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>{{ trans('file.category') }}</label><br>
            ...
            @foreach($faqs as $faq)
                ...
                <tr>
                    ...
                    <td class="not-exported">
                        ...
                        <a href="{{ url('faq/delete/') }}/{{ $faq->id }}" onclick="return confirmDelete()" class="btn btn-danger btn-sm"><i class="dripicons-trash"></i></a>
                    </td>
                </tr>
