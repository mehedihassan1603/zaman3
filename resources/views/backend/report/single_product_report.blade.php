...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            ...
            {!! Form::open(['route' => 'report.singleProductReport', 'method' => 'get']) !!}
    ...
    <div class="table-responsive">
        <table id="single-product-report-table" class="table table-hover" style="width: 100%">
            <thead>
                <tr>
                    <th>{{trans('file.Date')}}</th>
                    <th>{{trans('file.Product Name')}}</th>
                    <th>{{trans('file.Variant Name')}}</th>
...
<script type="text/javascript">
    ...
    $('#single-product-report-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('report.singleProductReportData') }}",
            type: "POST",
            data: {
        ...
        columnDefs: [
            {
                orderable: false,
                targets: [0, 1, 2, 3, 4] // only valid column indices
            }
        ],
