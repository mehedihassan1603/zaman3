                        ...
                        <div class="card-body">
                            ...
                            <div id="page-template" class="form-group">
                                ...
                                <ul id="widget-list" class="widgets">
                                    ...
                                    <li><a data-class="three-c-banner-widget"> {{trans('file.Three Column Banner')}}</a></li>
                                    <li><a data-class="two-c-banner-widget"> {{trans('file.Two Column Banner')}}</a></li>
                                    <li><a data-class="one-c-banner-widget"> {{trans('file.One Column Banner')}}</a></li>
                                    ...
                                    <li><a data-class="image-slider-widget"> {{trans('file.Image Slider Widget')}}</a></li>
                                </ul>
                                    ...
                                    <ul id="layout" class="widgets">
                                        @if(isset($page_widgets))
                                            @foreach($page_widgets as $widget)
                                                ...
                                                <li>
                                                    <a class="toggle-collapse"> {{trans('file.Three Column Banner')}} <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                                                    <div class="collapse">
                                                        <hr>
                                                        <form>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label>{{trans('file.Banner Image')}} 1</label>
                                                                    <input type="file" name="three_c_banner_image1" class="form-control">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>{{trans('file.Link')}} 1</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label>{{trans('file.Banner Image')}} 2</label>
                                                                    <input type="file" name="three_c_banner_image2" class="form-control">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>{{trans('file.Link')}} 2</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label>{{trans('file.Banner Image')}} 3</label>
                                                                    <input type="file" name="three_c_banner_image3" class="form-control">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>{{trans('file.Link')}} 3</label>
                                                ...
                                                <li>
                                                    <a class="toggle-collapse"> {{trans('file.Two Column Banner')}} <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                                                    <div class="collapse">
                                                        <hr>
                                                        <form>
                                                            <div class="row">
                                                ...
                                                <li>
                                                    <a class="toggle-collapse"> {{trans('file.One Column Banner')}} <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                                                    <div class="collapse">
                                                        <hr>
                                                        <form>
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <label>{{trans('file.Banner Image')}}</label>
                                                                    <input type="file" name="one_c_banner_image1" class="form-control">
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label>{{trans('file.Mobile Version')}}</label>
                                                                    <input type="file" name="one_c_banner_image1_mobile" class="form-control">
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label>{{trans('file.Link')}}</label>
                                                ...
                                                <li>
                                                    <a class="toggle-collapse"> {{trans('file.Image Slider')}} <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                                                    <div class="collapse">
                                                        <hr>
