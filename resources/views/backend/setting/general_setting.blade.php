                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']) !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{ trans('file.Profit Type') }} *</label>
                                    <select class="form-control" name="profit_type" required>
                                        <option value="">Select Profit Type</option>
                                        <option value="percentage"
                                            @if(isset($lims_general_setting_data) && $lims_general_setting_data->profit_type == 'percentage') selected @endif>
                                            Percentage
                                        </option>
                                        <option value="flat"
                                            @if(isset($lims_general_setting_data) && $lims_general_setting_data->profit_type == 'flat') selected @endif>
                                            Flat
                                        </option>
                                    </select>
                                    ...
                                    <input type="number" class="form-control" id="profit_margin" name="profit_margin"
                                        value="{{ isset($lims_general_setting_data) ? $lims_general_setting_data->profit_margin : '' }}" required>
                                </div>
                            </div>
