        ...
        <table id="products-table" class="table stock-count-list">
            <thead>
                <tr>
                    ...
                    <th>{{trans('file.Product Batch')}}</th>
                    <th>{{trans('file.Warehouse')}}</th>
                    <th>{{trans('file.Quantity')}}</th>
                    <th>{{trans('file.Price')}}</th>
                    <th>{{trans('file.Cost')}}</th>
                    <th>{{trans('file.Total Shipping')}}</th>
                    <th>{{trans('file.Total Discount')}}</th>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$key}}</td>
                    <td>{{ $get_P->product_name }}</td>
                    <td>{{ $get_P->batch_no }}</td>
                    <td>{{ $get_P->warehouse_name }}</td>
                    <td>{{ $get_P->qty }}</td>
                    <td>{{ $get_P->price }}</td>
                    <td>{{ $get_P->cost }}</td>
                    <td>{{ $get_P->t_shipping }}</td>
                    <td>{{ $get_P->t_disc }}</td>
                    ...
                    <td>
                        <input type="text" class="sale-price form-control" data-key="{{$key}}" readonly value="{{ $get_P->Sale_price }}">
                    </td>
