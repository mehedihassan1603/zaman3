                                ...
                                <table class="table">
                                    ...
                                    <tfooter>
                                        <tr>
                                            <th></th>
                                            <th>Shipping</th>
                                            <th class="price">(+) {{$currency->symbol ?? $currency->code}}{{ $sale->shipping_cost ?? '0' }}</th>
                                        </tr>
                                        <tr>
                                            <th></th>
                                            <th>Discount</th>
                                            <th class="price">(-) {{$currency->symbol ?? $currency->code}}{{ $sale->coupon_discount ?? '0' }}</th>
                                        </tr>
                                        <tr>
                                            <th></th>
                                            <th>Total</th>
                                            <th class="price">{{$currency->symbol ?? $currency->code}}{{ ($sale->grand_total - $sale->coupon_discount) }}</th>
                                        </tr>
                                    </tfooter>
                                </table>
                            </div>
