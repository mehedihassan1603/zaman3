...
@section('content')
    ...
    <section class="">
        <div class="col-md-6 offset-md-3 text-center mb-5">
            ...
            <h3 class="mt-3">{{trans('file.Sorry, your payment failed')}}</h3>
            <p class="lead">{{trans('file.Go back to checkout page and try again')}}- <span><a href="{{url('checkout')}}" class="theme-color">Checkout</a></span>.
        </div>
    </section>
    <!--Section ends-->
@endsection
