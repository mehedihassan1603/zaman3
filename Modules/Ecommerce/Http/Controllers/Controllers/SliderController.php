        ...
        foreach($orders as $key=>$order) {  
            ...
            if(isset($request->image1[$key])) { 
                ...
                if ($image1) {
                    ...
                    $imageName = $id . '.' . $ext;
                    //return $imageName;  
                    $image1->move('frontend/images/slider/desktop', $imageName);
                    $img_lg = Image::make('frontend/images/slider/desktop/'. $imageName)->fit(1090, 460)->save('frontend/images/slider/desktop/'. $imageName);
            ...
            if(isset($request->image2[$key])) { 
                ...
                if ($image2) {
                    ...
                    $imageName = $id . '.' . $ext;
                    //return $imageName;  
                    $image2->move('frontend/images/slider/tab', $imageName);
                    $img_lg = Image::make('frontend/images/slider/tab/'. $imageName)->fit(1090, 460)->save('frontend/images/slider/tab/'. $imageName);
            ...
            if(isset($request->image3[$key])) { 
                ...
                if ($image3) {
                    ...
                    $imageName = $id . '.' . $ext;
                    //return $imageName;  
                    $image3->move('frontend/images/slider/mobile', $imageName);
                    $img_lg = Image::make('frontend/images/slider/mobile/'. $imageName)->fit(650, 460)->save('frontend/images/slider/mobile/'. $imageName);
